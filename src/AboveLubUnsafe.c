...
int main(int argc, char** argv)
{
   ...
   /* prepend string to every log message */
    system("echo > /dev/null | sudo tee /var/log/syslog && logger [COURSE:2][ASSIGNMENT:5]: `uname -a`");
    openlog("[COURSE:2][ASSIGNMENT:5]", LOG_NDELAY, LOG_USER);
    ...
    services[1].data.threadCapacity = 2;
