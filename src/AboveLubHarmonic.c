...
int main(int argc, char** argv)
{
   ...
   /* prepend string to every log message */
    system("echo > /dev/null | sudo tee /var/log/syslog && logger [COURSE:2][ASSIGNMENT:3]: `uname -a`");
    openlog("[COURSE:2][ASSIGNMENT:3]", LOG_NDELAY, LOG_USER);
